...
export const useAccessoriesStore = defineStore("acessories", {
  state: () => ({
    accessories: [],
  ...
  actions: {
    async loadAccessories(entity: Entity, init: boolean) {
      ...
      if (error.value) {
        ...
        this.accessories = resData.items;
      }
    },
