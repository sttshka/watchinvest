globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/sttshka/Projects/freelance/watch-front/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, isEvent, createEvent, getRequestHeader, splitCookiesString, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, getQuery as getQuery$1, createError, getResponseStatusText } from 'file:///Users/sttshka/Projects/freelance/watch-front/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/sttshka/Projects/freelance/watch-front/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/sttshka/Projects/freelance/watch-front/node_modules/devalue/index.js';
import { renderToString } from 'file:///Users/sttshka/Projects/freelance/watch-front/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file:///Users/sttshka/Projects/freelance/watch-front/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/sttshka/Projects/freelance/watch-front/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/sttshka/Projects/freelance/watch-front/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/sttshka/Projects/freelance/watch-front/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/sttshka/Projects/freelance/watch-front/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///Users/sttshka/Projects/freelance/watch-front/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///Users/sttshka/Projects/freelance/watch-front/node_modules/klona/dist/index.mjs';
import { hash } from 'file:///Users/sttshka/Projects/freelance/watch-front/node_modules/ohash/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/sttshka/Projects/freelance/watch-front/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/sttshka/Projects/freelance/watch-front/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/sttshka/Projects/freelance/watch-front/node_modules/radix3/dist/index.mjs';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Users/sttshka/Projects/freelance/watch-front/node_modules/ipx/dist/index.mjs';
import { isAbsolute } from 'file:///Users/sttshka/Projects/freelance/watch-front/node_modules/pathe/dist/index.mjs';
import { version, unref } from 'file:///Users/sttshka/Projects/freelance/watch-front/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/sttshka/Projects/freelance/watch-front/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/sttshka/Projects/freelance/watch-front/node_modules/@unhead/shared/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "nitro": {
    ...
    "routeRules": {
      ...
      "/api/v1/**": {
        "proxy": {
          "to": "https://watchinvest.relabs.ru/api/v1/**",
          "_proxyStripBase": "/api/v1"
        }
      }
    }
  },
  ...
  "ipx": {
    ...
    "alias": {},
    "fs": {
      "dir": "/Users/sttshka/Projects/freelance/watch-front/public"
    },
    "http": {
      "domains": []
    }
...
const serverAssets = [{"baseName":"server","dir":"/Users/sttshka/Projects/freelance/watch-front/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/sttshka/Projects/freelance/watch-front","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/sttshka/Projects/freelance/watch-front/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/sttshka/Projects/freelance/watch-front/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/sttshka/Projects/freelance/watch-front/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/sttshka/Projects/freelance/watch-front/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _Yfm6nX = lazyEventHandler(() => {
...
const _lazy_3mw0Ey = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_3mw0Ey, lazy: true, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _Yfm6nX, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_3mw0Ey, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///Users/sttshka/Projects/freelance/watch-front/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/sttshka/Projects/freelance/watch-front/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
